...
public class MemberMissionNotInProgressValidator implements ConstraintValidator<CheckMemberMissionInProgress, MemberMissionRequestDTO.CreateMemberMissionDto> {
