...
public class MemberMissionInProgressValidator implements ConstraintValidator<CheckMemberMissionInProgress, MemberMissionRequestDTO.CreateMemberMissionDto> {
